...
$(document).ready(function () {
    // Event listener for when a new zone is selected
    $('#zone').change(function () {
        // Get the selected zone name
        var selectedZone = $(this).val();
        
        // Set the selected zone name to the appropriate field
        $('#selected_zone').text(selectedZone);
        
        // Here you can add an AJAX call to fetch and display departments related to the selected zone
        // For now, let's assume you have an array of departments related to each zone
        var departments = {
            "Zone1": ["Department1", "Department2", "Department3"],
            "Zone2": ["Department4", "Department5", "Department6"],
            // Add more zones and departments as needed
        };
        ...
        // Add default option
        $('#name').append('<option value="">Select Department</option>');

        // If the selected zone has associated departments, populate the department select box
        if (departments[selectedZone]) {
            departments[selectedZone].forEach(function (department) {
                $('#name').append('<option value="' + department + '">' + department + '</option>');
            });
        }
    });
});

...
@section('content')
<div class="container">
    <h2 class="main-title p-3 " style="margin-right:900px;font-weight: bold; margin-top:-77px;">Add Zone Master</h2>
            ...
            <form action="{{ route('zones.store') }}" method="POST">       
                ...
                <div class="row">
                    <div class="form-group col-md-4" style="height:1300px;">
                        ...
                        <input type="text" class="form-control" id="zone" name="zone" placeholder="Enter zone name" fdprocessedid="gvitjf" >
                        <p class="name text-danger"></p>
                    </div>
                    
                    <div class="form-group col-md-8">
                        <label class="fw-bold" for="details" style="margin-right:690px;">Details</label>
                        <textarea class="form-control" id="details" name="details" placeholder="Enter Details" fdprocessedid="akmo0w" style="width:600px; height: 77px; "></textarea>
...
<style>
    .fa.fa-plus.float-end.add {
      ...
      <!-- Add the missing part for displaying department names and actions within the table -->
<table class="table">
    <thead>
        <tr>
            <th>Name</th>
    ...
    <tbody id="dept_table">
        ...
        @endforeach
            ...
            <button type="submit" class="btn btn-success save" id="btna" style="margin-left:989px;width:120px;margin-top:-189px;">Save</button>
        </div>
